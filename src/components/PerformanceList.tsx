...
import { serverAPI, Performance } from '../data/apiService';
    ...
    const fetchPerformances = async (searchParams?: {
        ...
        try {
            ...
            const formattedPerformances = performanceData.map((perf) => ({
                ...
                description: perf.theme, // description이 없으므로 theme으로 대체
            ...
            <div className="space-y-4">
                ...
                {hasAppliedFilters && (
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Button
                            key="clear-all-button" // 일관성을 위해 이 key도 추가
                            variant="ghost"
                            size="sm"
