...
export function SeatSelection({
    ...
    // 2) (유지/추가) selectedSchedule → ref 동기화
    useEffect(() => {
    ...
    useEffect(() => {
        let cancelled = false;
        (async () => {
            if (!selectedSchedule || sessionReady) return;
            try {
                const resp = await queueService.checkQueueRequirement(
                    performanceId,
                    selectedSchedule
                );
                ...
                if (sessionId && !cancelled) {
                    ...
                    console.log("[QUEUE] sessionId pre-fetched:", sessionId);
                } else {
                    console.log("[QUEUE] sessionId not provided yet");
                }
            } catch (e) {
    ...
    }, [performanceId, selectedSchedule, sessionReady]);
    ...
    useEffect(() => {
        ...
        const releaseSession = () => {
            ...
            if (!sessionId || !scheduleId) {
                console.log("⏭️ 큐 세션 또는 스케줄 없음 — release-session 전송 생략");
                return;
            }
            const payload = {
            ...
            console.log("📡 release-session beacon:", ok ? "성공" : "실패", payload);
        };
    ...
    }, [sessionReady, performanceId, user.userId]);
    ...
    const findSectionForSeat = useCallback((rowLabel: string, col: number, zone: string | undefined, sections: SeatMapSection[]): {
                                ...
                                <div className="min-h-[60vh] p-6 bg-white">
                                    <div className="max-w-7xl mx-auto">
                                        <div
                                            ...
                                            <div className="flex flex-col lg:flex-row gap-8 p-6">
                                                <div className="flex-1">
                                                    ...
                                                    <div
                                                        className="mt-6 flex flex-wrap gap-6 justify-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                                                        <div className="flex items-center gap-2">
                                                            <div
                                                                className="w-7 h-7 bg-gray-100 border border-gray-300 rounded-md flex items-center justify-center text-gray-800 text-xs">1
                                                            </div>
                                                            <span className="text-sm text-gray-600">선택가능</span>
                                                        </div>
                                                        <div className="flex items-center gap-2">
                                                            <div
                                                                className="w-7 h-7 bg-blue-600 border border-blue-600 rounded-md flex items-center justify-center text-white text-xs">2
                                                            </div>
                                                            <span className="text-sm text-gray-600">선택됨</span>
                                                        </div>
                                                        <div className="flex items-center gap-2">
                                                            <div
                                                                className="w-7 h-7 bg-gray-300 border border-gray-400 rounded-md flex items-center justify-center text-gray-600 text-xs">
                                                                <X className="w-3 h-3"/>
                                                            </div>
                                                ...
                                                <div className="lg:w-80">
                                                    <Card className="bg-gray-50 rounded-md sticky top-4">
                                                        <CardHeader className="pb-2">
                                                            <CardTitle className="text-base font-semibold">선택
                                                                좌석</CardTitle>
                                                        </CardHeader>
                                                        <CardContent className="pt-0 space-y-4">
                                                            <div>
                                                                <h3 className="text-xs font-medium text-gray-600 mb-2">좌석
                                                                    등급 (요금)</h3>
                                      ...
                                      <span className="flex items-center gap-2">
                                        <span
                                            className={`inline-block w-3 h-3 rounded-sm ${gradeSwatchClass[grade] ?? 'bg-orange-600'}`}/>
                                          {grade}석
                                      </span>
                                                                            <span
                                                                                className="text-gray-900">₩{Number(price).toLocaleString()}</span>
                                                                        </div>
                                                                    ))}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <h3 className="text-xs font-medium text-gray-600 mb-2">선택한
                                                                    좌석</h3>
                                                                <div
                                                                    ...
                                                                    {selectorSelectedCodes.size > 0 ? (
                                                                            ...
                                                                            {Array.from(selectorSelectedCodes).map((seatId) => {
                                                                                ...
                                                                                return (
                                                                                    <div key={seatId}
                                                                                        ...
                                                                                        <span
                                                                                            className="text-sm text-gray-700">{seatId} · {grade}석</span>
                                                                                        <span
                                                                                            className="text-sm font-medium text-gray-900">₩{price.toLocaleString()}</span>
                                                                                    </div>
                                                                                );
                                                                            })}
                                                                        </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p className="text-gray-400 text-sm">좌석을
                                                                                선택해주세요</p>
                                                                        </div>
                                                                    )}
                                                                </div>
                                                            ...
                                                            <div className="border-t border-gray-200 pt-3">
                                                                <div className="flex justify-between items-center">
                                                                    ...
                                                                    <span
                                                                        className="text-lg font-semibold text-blue-600">₩{selectorTotal.toLocaleString()}</span>
                                                                </div>
                                                            </div>
